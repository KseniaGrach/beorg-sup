            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{route('department.index')}}" class="nav-link">
                                        <p class="pl-4">Отделы</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('type.index')}}" class="nav-link">
                                        <p class="pl-4">Типы проектов</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('duration.index')}}" class="nav-link">
                                        <p class="pl-4">Сроки проектов</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('project.global.index')}}" class="nav-link">
                                    <p class="pl-4">Список проектов</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('project.self.index')}}" class="nav-link">
                                    <p class="pl-4">Мои проекты</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('meeting.index')}}" class="nav-link">
                                    <p class="pl-4">Конференции</p>
                                </a>
                            </li>
                            @role('super_admin,analyst')
                                <li class="nav-item">
                                    <a href="{{route('instruction.index')}}" class="nav-link">
                                        <p class="pl-4">Закрытие месяца</p>
                                    </a>
                                </li>
                            @endrole
                        </ul>
